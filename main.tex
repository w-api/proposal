...
In addition to attracting the community of researchers that usually attend ICSE and its co-located events (e.g., MSR, ICPC), we will make intensive efforts to involve local industry participants who can share their experience in using and maintaining APIs, as well as researchers from \updated{Scandinavia}.
\end{abstract}
...
\rk{May want to cite paper(s) from last year's workshop.} % chktex 36
